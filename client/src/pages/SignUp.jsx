          ...
          >
            ...
            <div className="text-center mb-8">
              <motion.div
                ...
                className="w-16 h-16 bg-[#ef476f] rounded-full flex items-center justify-center mx-auto mb-4
"
              >
              ...
              <p className="text-gray-600">
                Join ShopEase Shopping and start your journey
              </p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <motion.button
                ...
                className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white transition-all duration-200 ${
                 checked
    ? "bg-[#ef476f] hover:bg-[#d63f63] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ef476f]"
