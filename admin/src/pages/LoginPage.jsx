        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#ef476f] text-white py-3 px-6 rounded-xl font-semibold hover:bg-[#d63f63] focus:ring-4 focus:ring-[#ef476f]/50 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none
"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link
                to="/register"
                className="text-[#ef476f] hover:text-[#d63f63] font-semibold transition-colors duration-200"
              >
                Create Account
              </Link>
            </p>
