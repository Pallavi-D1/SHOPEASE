...
className="bg-pink-300 text-white px-6 py-2 rounded-md hover:bg-gray-800 transition-colors"
>
View All Orders
</button>
</div>
...
className="w-full flex items-center justify-center gap-3 bg-[#ef476f] text-white py-3 px-4 rounded-lg hover:bg-[#d93c61] transition-colors font-medium"
>
...
<button
onClick={() => navigate("/orders")}
className="w-full bg-[#ef476f] text-white py-3 px-4 rounded-lg hover:bg-[#d93c61] transition-colors font-medium"
>
View All Orders
</button>
</div>
