      ...
      <Container className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">ShopEase</h3>
            ...
            {subscription ? (
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full bg-brandRed hover:bg-pink-700 text-white py-3 rounded-lg transition-colors duration-200"
                >
                  Subscribe
                </Button>
              </div>
