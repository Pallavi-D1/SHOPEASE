...
const Home = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-[#ef476f] hover:text-[#c63b5a] text-sm font-medium">
              View All
            </button>
          </div>
          ...
          <div className="space-y-4">
            {stats.topProducts.length > 0 ? (
              stats.topProducts.map((product, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-[#ef476f] rounded-xl flex items-center justify-center text-white font-bold">
                    {index + 1}
                  </div>
      ...
      {/* Quick Actions */}
      <div className="bg-gradient-to-r from-[#ef476f] to-[#d63f63] rounded-2xl p-8 text-white">
