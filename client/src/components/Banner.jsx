...
const bannerData = [
  {
    title: "Most Loved",
    subtitle: "Top selling Blazers",
    description:
      "Discover the latest Designs with exclusive discounts",
  ...
  {
    title: "Geometric Artificial Jewellery",
    subtitle: "The best deals on Jewellery",
    description: "Artificial jewellery - Multi-layer necklace",
    discount: "$200 off",
    from: 1559.99,
    sale: "Special Offer",
    image: bannerImgTwo,
  ...
  },
  {
    ...
    subtitle: "Premium Makeup Products",
    description: "Discover the products with exclusive discounts",
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        className="group relative inline-flex items-center gap-3 lg:gap-4 px-8 lg:px-10 py-4 lg:py-5 bg-brandRed hover:bg-brandRedDark text-white text-sm lg:text-base font-bold uppercase tracking-wider overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                      >
                        <span className="absolute inset-0 bg-brandRed transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
