    ...
    <>
      {existingProduct ? (
        ...
        <button
          ...
          className="w-full border border-brandRed text-brandRed text-xs font-medium py-3 px-6 uppercase tracking-wide hover:bg-brandRed hover:text-white transition-all duration-200"
        >
          Add to cart
        </button>
      )}
