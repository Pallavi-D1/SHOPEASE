            ...
            >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                      {avatarPreview || formData.avatar ? (
                        ...
                        <div className="w-16 h-16 bg-[#ef476f] rounded-full flex items-center justify-center text-white font-semibold text-xl">
                          {formData.name
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4 sm:pt-6 border-t border-gray-200 mt-6">
                ...
                {!isReadOnly && (
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-4 sm:px-6 py-2.5 bg-[#ef476f] 
                    text-white rounded-lg hover:bg-[#d63f63] 
                    focus:ring-2 focus:ring-[#ef476f] transition-all duration-200 
