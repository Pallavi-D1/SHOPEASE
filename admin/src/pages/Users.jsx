          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#262626] text-white rounded-lg hover:bg-[#262626] transition-colors font-medium"
                title="Refresh Users"
              >
              ...
              {isAdmin && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#ef476f] text-white rounded-lg hover:bg-[#d63f63] transition-colors font-medium"
                >
                          ...
                          <div className="flex items-center">
                            <div className="relative">
                              {user.avatar ? (
                                ...
                                <div className="w-10 h-10 bg-gradient-to-br from-[#ef476f] to-[#d63f63] rounded-full flex items-center justify-center text-white font-semibold">
