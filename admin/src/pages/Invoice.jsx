    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl shadow-sm p-12">
          <div className="mb-8">
            <div className="w-24 h-24 bg-gradient-to-br from-[#ef476f] to-[#b63758] rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              and advanced billing features are available.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 mb-8 border border-amber-200">
            ...
            <div className="text-xs text-amber-700 bg-amber-100 px-3 py-2 rounded-full inline-block mt-4">
              ⚡ Secure payment • Shopping updated • Call support
            </div>
          </div>
          ...
          <a
            ...
            target=""
            rel=""
            className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#ef476f] to-[#b63758] text-white px-8 py-4 rounded-xl hover:from-[#d74265] hover:to-[#a6304c] transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-lg"
          >
