      ...
      <div className="py-2.5 flex items-center justify-between px-4">
        ...
        <Link to={"/"} className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block">
            <p className="text-xs uppercase font-bold tracking-wide text-[#ef476f]">
              Admin Panel
            </p>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 bg-blue-50 px-3 py-1.5 rounded-full">
            <FaUserShield className="text-[#ef476f] text-sm" />
            <span className="text-sm font-medium text-[#ef476f]">Admin</span>
          </div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {user?.avatar ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#ef476f] to-[#b63559] text-white flex items-center justify-center font-semibold text-sm
">
