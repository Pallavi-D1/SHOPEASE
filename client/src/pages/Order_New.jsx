                ...
                <div className="text-center">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 mb-6 max-h-40 overflow-y-auto">
                    ...
                    <div className="pt-2 mt-2 border-t border-gray-300">
                      <div className="flex justify-between text-sm font-medium">flex-1 px-4 py-2 text-sm font-medium text-white bg-[#ef476f] border border-transparent rounded-md hover:bg-[#d63f63] transition-colors flex items-center justify-center gap-2
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-2 text-sm font-medium text-white bg-[#ef476f] border border-transparent rounded-md hover:bg-[#d63f63] transition-colors flex items-center justify-center gap-2"
                    >
                      <FaShoppingCart className="w-4 h-4" />
                      Add to Cart
                    </button>
