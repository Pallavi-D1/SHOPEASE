        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-12">
              <div className="mb-8">
                <div className="w-24 h-24 bg-[#ef476f] rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <a
                ...
                target=""
                rel=""
                className="inline-flex items-center justify-center gap-3 bg-[#ef476f] text-white px-8 py-4 rounded-xl hover:bg-[#d63c5e] transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-lg
"
              >
